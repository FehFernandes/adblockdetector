      ...
      <main className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-700 max-w-2xl mx-auto leading-relaxed">
            Nosso conteúdo é mantido através de anúncios responsáveis. Por
            favor, considere nos apoiar desativando seu bloqueador.
          </p>
        </motion.div>
        ...
        >
          <div
            className={`bg-white border-2 ${
              adBlockDetected ? "border-red-400" : "border-green-400"
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-lg text-gray-700">
                  Ajuda a manter nosso conteúdo gratuito
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 w-6 h-6 rounded-full bg-indigo-100 flex items-center justify-center flex-shrink-0">
                ...
                <span className="text-lg text-gray-700">
                  Permite que continuemos produzindo conteúdo de qualidade
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 w-6 h-6 rounded-full bg-indigo-100 flex items-center justify-center flex-shrink-0">
                ...
                <span className="text-lg text-gray-700">
                  Garante o funcionamento adequado do site
                </span>
              </li>
            </ul>
          </motion.div>
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                  Para continuar navegando em nosso site, por favor desative seu
                  bloqueador de anúncios. Nós utilizamos anúncios não intrusivos
                  para manter nosso conteúdo gratuito e de qualidade.
                </p>
                <button
                  onClick={() => setShowPopup(false)}
